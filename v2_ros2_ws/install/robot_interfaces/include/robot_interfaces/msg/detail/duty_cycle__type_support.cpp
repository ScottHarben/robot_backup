...
{
  new (message_memory) robot_interfaces::msg::DutyCycle(_init);
}

void DutyCycle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces::msg::DutyCycle *>(message_memory);
  typed_message->~DutyCycle();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DutyCycle_message_member_array[2] = {
  {
    ...
    offsetof(robot_interfaces::msg::DutyCycle, duty_cycle_left),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::DutyCycle, duty_cycle_right),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DutyCycle_message_members = {
  ...
  2,  // number of fields
  sizeof(robot_interfaces::msg::DutyCycle),
...
get_message_type_support_handle<robot_interfaces::msg::DutyCycle>()
{
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::DutyCycle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, msg, DutyCycle)() {
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::DutyCycle_message_type_support_handle;
}
