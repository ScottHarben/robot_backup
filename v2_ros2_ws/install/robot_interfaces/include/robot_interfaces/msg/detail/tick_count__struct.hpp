...
struct TickCount_
{
  ...
  using _tower_tick_count_type =
    int16_t;
  _tower_tick_count_type tower_tick_count;
  ...
  Type & set__tower_tick_count(
    const int16_t & _arg)
  {
    this->tower_tick_count = _arg;
    return *this;
  }
  ...
  bool operator==(const TickCount_ & other) const
  {
    ...
    if (this->tower_tick_count != other.tower_tick_count) {
      return false;
    }
    return true;
  }
