...
#include "robot_interfaces/msg/detail/wheel_rpm__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::WheelRPM & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::WheelRPM & ros_message)
{
  // Member: rpm_left
  cdr >> ros_message.rpm_left;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::WheelRPM;
    is_plain =
      (
      offsetof(DataType, rpm_right) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::WheelRPM *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::WheelRPM *>(
    untyped_ros_message);
...
static size_t _WheelRPM__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_WheelRPM(full_bounded, is_plain, 0);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_WheelRPM__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, WheelRPM)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_WheelRPM__handle;
}
