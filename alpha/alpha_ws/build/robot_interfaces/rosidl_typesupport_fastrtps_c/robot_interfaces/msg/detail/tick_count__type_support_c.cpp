  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces__msg__TickCount;
    is_plain =
      (
      offsetof(DataType, right_wheel_tick_count) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _TickCount__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_robot_interfaces__msg__TickCount(
