...
class WheelRPM(metaclass=Metaclass_WheelRPM):
    ...
    def rpm_left(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'rpm_left' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def rpm_right(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'rpm_right' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
